#echo "Generating encoded Skin Cancer MNIST data"
#python3 skin_cancer_mnist-intermediate-layer-op.py

cp data/skin_cancer_mnist_256_dense data/vecs.txt
cp data/skin_cancer_mnist_dx.txt data/p.txt
cp data/skin_cancer_mnist_sex.txt data/s1.txt
cp data/skin_cancer_mnist_age.txt data/s2.txt
